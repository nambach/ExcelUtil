...
public class Data {
    ...
    public static List<Book> BOOKS_1;
    public static List<Book> BOOKS_2;
    public static List<Book> BOOKS_3;

    static {
        try {
            BOOKS_1 = Arrays.asList(
